    ...
    >
      ...
      <div className="absolute top-[60px] left-[60px] flex items-center gap-4 z-20 w-[400px]">
        <div className="w-[54px] h-[54px] rounded-full border-[2px] border-[#D4AF37] flex items-center justify-center bg-white shadow-lg overflow-hidden shrink-0">
          <img src="/api/proxy-image?url=https://results.fedpolybida.edu.ng/img/favicon.ico" crossOrigin="anonymous" alt="FPB Logo" className="w-full h-full object-contain p-1" />
        </div>
        <div className="w-[54px] h-[54px] rounded-full border-[2px] border-[#D4AF37] flex items-center justify-center bg-white shadow-lg overflow-hidden shrink-0">
          <img src="/api/proxy-image?url=https://nacos.org.ng/img/about.jpg" crossOrigin="anonymous" alt="NACOS Logo" className="w-full h-full object-cover" />
        </div>
