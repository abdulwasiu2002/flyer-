...
"linear-gradient(135deg,#ffffff 0%,#fcfcfa 30%,#f6faf7 65%,#eef8f1 100%)",
      ...
      >
        ...
        <div className="absolute inset-0 bg-[#0B5D3B] z-0">
          ...
          >
            <path
              d="M100 800 L300 900 L150 1050 L350 1150 L200 1250"
              stroke="#D4AF37"
              strokeWidth="1"
              fill="none"
              strokeDasharray="4,4"
            />
            <path
              d="M300 900 L400 1000 L350 1150"
              stroke="#D4AF37"
              strokeWidth="1"
              fill="none"
              strokeDasharray="4,4"
            ...
            <path
              d="M 250 850 Q 280 820 320 850 Q 360 830 380 870 Q 410 880 400 910 Q 420 940 380 960 Q 350 980 310 950 Q 270 970 240 940 Q 210 910 230 880 Q 210 850 250 850 Z"
              stroke="#ffffff"
              strokeWidth="1"
              fill="none"
              strokeDasharray="2,6"
...
/>
          ...
          <div
            ...
            style={{
              backgroundImage: "radial-gradient(#0B5D3B 2px, transparent 2px)",
...
/>
          ...
          <div className="mt-8 text-center space-y-1">
            <h2 className="text-[26px] font-['Poppins'] font-extrabold text-[#1E1E1E] uppercase tracking-wide leading-[1.1] px-4">
              {data.full_name || "YOUR NAME"}
            </h2>
            {data.nickname && (
              <p className="text-[16px] font-['Poppins'] font-semibold text-[#D4AF37] tracking-[0.1em] uppercase mt-1">
            ...
            <div className="flex items-center justify-center gap-3 mt-4">
              ...
              <p className="text-[11px] font-['Montserrat'] font-bold tracking-[0.2em] text-[#1E1E1E] uppercase">
                {data.post_held !== "None"
                  ? data.post_held
                  : "Social Handle : @networking"}
              </p>
              <div className="h-px w-8 bg-[#D4AF37]"></div>
            </div>
          </div>
...
>
  <div className="flex flex-col gap-[28px]">
            ...
            <InfoSection title="Academic Profile">
              <DetailRow
                label="Best Course & Level"
                value={`${data.best_course} / ${data.best_level}`}
              />
              <DetailRow
                label="Hardest Course & Level"
                value={`${data.challenging_course} / ${data.challenging_level}`}
              />
              <DetailRow
            ...
            <InfoSection title="Campus Experience">
              <DetailRow
                label="Best Experience In Campus"
            ...
            <InfoSection title="Future">
              <DetailRow
                label="What's Next After School"
...
/>
        ...
        <div className="absolute bottom-[50px] right-[60px] w-[460px] z-20 flex items-center justify-between">
          <div className="flex flex-col">
            <h4 className="text-[12px] font-['Montserrat'] font-bold text-[#1E1E1E] uppercase tracking-[0.25em]">
              Networking & Cloud Computing
            </h4>
            <div className="w-[80px] h-[1.5px] bg-gradient-to-r from-[#D4AF37] to-transparent my-1.5"></div>
            <p className="text-[10px] font-['Inter'] font-semibold text-[#1E1E1E]/60 uppercase tracking-widest">
              Federal Polytechnic Bida
            </p>
            <p className="text-[9px] font-['Montserrat'] font-bold text-[#D4AF37] uppercase tracking-[0.3em] mt-0.5">
              Class of 2026
            </p>
          </div>
